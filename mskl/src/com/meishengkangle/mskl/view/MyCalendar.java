...
public class MyCalendar extends ViewFlipper implements
	...
	public static final int COLOR_TX_THIS_MONTH_DAY = Color
			.parseColor("#616161"); // 当前月日历数字颜色
	public static final int COLOR_TX_OTHER_MONTH_DAY = Color
			.parseColor("#ffcccccc"); // 其他月日历数字颜色
	public static final int COLOR_TX_THIS_DAY = Color.parseColor("#616161"); // 当天日历数字颜色
...
//	private ImageView iv_state_finish,iv_state_buy,iv_state_omit;
...
//				col.setBackgroundResource(R.drawable.calendar_day_bg);
				...
				if (i == 0 && j == 0 && weekday != 0) {
					...
					for (int k = 0; k < weekday; k++) {
						...
						if (group.getChildCount() > 0) {
							...
							LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
									-1, -1);
							view=View.inflate(getContext(), R.layout.calendar_item, null);
							tv_day = (TextView) view.findViewById(R.id.tv_day);
							view.setLayoutParams(params);
							tv_day.setGravity(Gravity.CENTER);
							group.addView(view);
						}
						tv_day.setText(Integer.toString(lastMonthDay));
						tv_day.setTextColor(COLOR_TX_OTHER_MONTH_DAY);
					...
					if (day <= lastDay) {
						...
						if (thisday.getDate() == day
							...
							tv_day.setText("今天");
							tv_day.setTextColor(getResources().getColor(R.color.color_green));
							view.setBackgroundColor(Color.TRANSPARENT);
						} else {
							tv_day.setTextColor(COLOR_TX_THIS_MONTH_DAY);
							view.setBackgroundColor(Color.TRANSPARENT);
						}
						...
						tv_day.setText(Integer.toString(nextMonthDay));
						tv_day.setTextColor(COLOR_TX_OTHER_MONTH_DAY);
						// 设置日期背景色
						if (dayBgColorMap.get(dates[i][j]) != null) {
							// view.setBackgroundResource(dayBgColorMap
	...
	public void removeAllBgColor() {
		dayBgColorMap.clear();
		System.out.println(""+dayBgColorMap);
		setCalendarDate();
	}
